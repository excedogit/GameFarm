...
class open_invoices_xls(report_xls):
    ...
    def print_columns_title(self, _p, data, row_position):  # Fill in a row with the titles of the columns for the invoice lines: Date - Period - Entry -...
        ...
        if data['form']['hide_period']:
            ...
            c_specs = [
                ...
                ('payment_term',1,0,'text',_('Payment Term'),None,style_yellow_bold),
                ('due', 1, 0, 'text', _('Not Due'),None,style_yellow_bold),
                ('od30', 1, 0, 'text', _('0-30'),None,style_yellow_bold),
                ('od60', 1, 0, 'text',_('30-60'),None,style_yellow_bold),
                ('od90', 1, 0, 'text',_('60-90'),None,style_yellow_bold),
                ('od120', 1, 0, 'text',_('90-120'),None,style_yellow_bold),
                ('older', 1, 0, 'text', _('+120'),None,style_yellow_bold),
                ('balance', 1, 0, 'text', _('Total'),None,style_yellow_bold),
                ('coments', 1, 0, 'text', _('Comments'),None,style_yellow_bold),
                ('payment_next_Action_date',1,0,'text',_('Next Action Date'),None,style_yellow_bold),
            ]
    ...
    def print_group_cumul_account(self,row_position, row_start_account, acc):
        ...
        c_specs = [
            ...
            ('payment_term', 1, 0, 'text',_('Payment Term')),
...
open_invoices_xls('report.account.new_account_report_aged_partner_balance_xls', 'account.account', parser=new_aged_trial_report)
