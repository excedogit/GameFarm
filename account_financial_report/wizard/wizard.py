...
class wizard_report(osv.osv_memory):
    ...
    _columns = {
        ...
        # Added Temporary Field to Carry Period Ids Every Time................
        'temp_periods':fields.char('Temporary Field to Carry Periods to print Report and Over Ride Its Error',size=240),  
    }
    ...
    def print_report(self, cr, uid, ids, data, context=None):
        #print "Testing the Data Here :::::::::::",data
        if context is None:
            context = {}
        ...
        # Statically Passing Periods Heree:::",
        periods=[]
        import unicodedata
        temp_periods=eval(unicodedata.normalize('NFKD', data['form']['temp_periods']).encode('ascii','ignore'))
        #temp_periods=[str(x) for x in data['form']['temp_periods']]
        for i,ele in enumerate(temp_periods):
            periods.append(ele)
        #print "Data Form Here :::::::::::::",temp_periods[-1]
